...
if (!isset($_POST['nome']) || empty($_POST['turma'])) {
    $_SESSION['erro'] = "⚠ Aluno não selecionado ou inválido! Volte e escolha um aluno válido.";
    header("Location: index.php");
    exit;
}
// Buscar a turma no banco
...
if (!$turma) {
    die("⚠ Turma não encontrada! Volte e escolha um aluno válido.");
}
...
<head>
    ...
    <title>Autorização de Entrada</title>
...
<body>
    <div class="print">
        ...
        <div class="texto">
            <b>TURMA:</b> &nbsp;<?php echo $_SESSION['ALUNO']['TURMA']; ?>&nbsp;
        </div>
        <div class="texto">
